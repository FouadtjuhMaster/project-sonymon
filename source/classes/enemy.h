...
void ENEMY::UseMove(int &enemyHealth, int &enemyAttackPower, int enemy_type, int enemyRealType, const char * name, OSL_IMAGE *image, OSL_IMAGE *playerSonymon, OSL_IMAGE *background)
{
     ...
     if(sonymon_num == 1)      sonymonType = sonymon1_type;
     else if(sonymon_num == 2) sonymonType = sonymon2_type;
     else if(sonymon_num == 3) sonymonType = sonymon3_type;
     ...
     if(enemyUsedMove == 1)
     {
        ...
        enemyAttack = ApplyAttackValue(enemyMove1, enemyAttackPower);
        ApplyTypes(enemyMove1, enemyAttack, sonymonType, ENEMY_EFFECT);
        animate.flashHurtPlayer(playerSonymon, image, background);
        
        if(sonymon_num == 1) enemyAttack -= sonymon1_defense;
        else if(sonymon_num == 2) enemyAttack -= sonymon2_defense;
        else if(sonymon_num == 3) enemyAttack -= sonymon3_defense;
     }
     ...
     else if(enemyUsedMove == 2)
     {
        ...
        enemyAttack = ApplyAttackValue(enemyMove2, enemyAttackPower);
        ApplyTypes(enemyMove2, enemyAttack, sonymonType, ENEMY_EFFECT);
        animate.flashHurtPlayer(playerSonymon, image, background);
     ...
     else if(enemyUsedMove == 3)
     {
        ...
        enemyAttack = ApplyAttackValue(enemyMove3, enemyAttackPower);
        ApplyTypes(enemyMove3, enemyAttack, sonymonType, ENEMY_EFFECT);
        animate.flashHurtPlayer(playerSonymon, image, background);
     ...
     else if(enemyUsedMove == 4)
     {
        ...
        enemyAttack = ApplyAttackValue(enemyMove4, enemyAttackPower);
        ApplyTypes(enemyMove4, enemyAttack, sonymonType, ENEMY_EFFECT);
        animate.flashHurtPlayer(playerSonymon, image, background);
     ...
     if(sonymon_num == 1) sonymon1_health -= enemyAttack;
     else if(sonymon_num == 2) sonymon2_health -= enemyAttack;
     else if(sonymon_num == 3) sonymon3_health -= enemyAttack;

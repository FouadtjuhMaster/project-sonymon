...
void UPDATE_TURN::UsedMove(int &enemyHealth, const int enemyDefense, const int enemyRealType, OSL_IMAGE * enemy, OSL_IMAGE * background)
{
     ...
     if(usedFirstMove)
     {
         ...
         attack = ApplyAttackValue(move1, power);
         ApplyTypes(move1, attack, enemyRealType, EFFECT);
     ...
     if(usedSecondMove)
     {
         ...
         attack = ApplyAttackValue(move2, power);
         ApplyTypes(move2, attack, enemyRealType, EFFECT);
         animate.flashHurtEnemy(sonymon, enemy, background);
         attack -= enemyDefense;
         if(attack <= 0) attack = 1; 
     ...
     if(usedThirdMove)
     {
         ...
         attack = ApplyAttackValue(move3, power);
         ApplyTypes(move3, attack, enemyRealType, EFFECT);
         animate.flashHurtEnemy(sonymon, enemy, background);
         attack -= enemyDefense;
         if(attack <= 0) attack = 1; 
     ...
     { 
         ...
         attack = ApplyAttackValue(move4, power);
         ApplyTypes(move4, attack, enemyRealType, EFFECT);
         animate.flashHurtEnemy(sonymon, enemy, background);
         attack -= enemyDefense;
         if(attack <= 0) attack = 1; 
...
{        
     ...
     if(sonymon_num == 1){
           power = sonymon1_attack;
           sonymon = sonymon_pic1;
           name = sonymon1_name;
           ...
           moveName2 = sonymon1_moveName1;
           moveName3 = sonymon1_moveName1;
           moveName4 = sonymon1_moveName1;
     }
     else if(sonymon_num == 2){
           power = sonymon2_attack;
           sonymon = sonymon_pic2;
           name = sonymon2_name;
           ...
           moveName2 = sonymon2_moveName1;
           moveName3 = sonymon2_moveName1;
           moveName4 = sonymon2_moveName1;
     }
     else if(sonymon_num == 3){
           power = sonymon3_attack;
           sonymon = sonymon_pic3;
           name = sonymon3_name;
           ...
           moveName2 = sonymon3_moveName1;
           moveName3 = sonymon3_moveName1;
           moveName4 = sonymon3_moveName1;  
     }
